    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'plumbing_interface_demo.msg.CustomMsg')
            logger.debug(
...
class CustomMsg(metaclass=Metaclass_CustomMsg):
    ...
    def __init__(self, **kwargs):
        ...
        self.data_int = kwargs.get('data_int', int())
        self.data_float = kwargs.get('data_float', float())
    ...
    def __eq__(self, other):
        ...
        if self.name != other.name:
            return False
        if self.data_int != other.data_int:
            return False
        if self.data_float != other.data_float:
            return False
        return True
    ...
    @builtins.property
    def data_int(self):
        """Message field 'data_int'."""
        return self._data_int

    @data_int.setter
    def data_int(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'data_int' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'data_int' field must be an integer in [-2147483648, 2147483647]"
        self._data_int = value

    @builtins.property
    def data_float(self):
        """Message field 'data_float'."""
        return self._data_float

    @data_float.setter
    def data_float(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'data_float' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'data_float' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._data_float = value
