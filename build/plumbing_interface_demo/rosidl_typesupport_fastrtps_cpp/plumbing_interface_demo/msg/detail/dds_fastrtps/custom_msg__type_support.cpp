...
#include "plumbing_interface_demo/msg/detail/custom_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const plumbing_interface_demo::msg::CustomMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plumbing_interface_demo::msg::CustomMsg *>(
    untyped_ros_message);
...
{
  return &plumbing_interface_demo::msg::typesupport_fastrtps_cpp::_CustomMsg__handle;
}
