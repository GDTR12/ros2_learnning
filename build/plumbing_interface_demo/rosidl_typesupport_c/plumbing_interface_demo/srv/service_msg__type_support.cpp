...
static const _ServiceMsg_Request_type_support_symbol_names_t _ServiceMsg_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plumbing_interface_demo, srv, ServiceMsg_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plumbing_interface_demo, srv, ServiceMsg_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plumbing_interface_demo, srv, ServiceMsg_Request)() {
  return &::plumbing_interface_demo::srv::rosidl_typesupport_c::ServiceMsg_Request_message_type_support_handle;
}
...
static const _ServiceMsg_Response_type_support_symbol_names_t _ServiceMsg_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plumbing_interface_demo, srv, ServiceMsg_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plumbing_interface_demo, srv, ServiceMsg_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plumbing_interface_demo, srv, ServiceMsg_Response)() {
  return &::plumbing_interface_demo::srv::rosidl_typesupport_c::ServiceMsg_Response_message_type_support_handle;
}
...
static const _ServiceMsg_type_support_symbol_names_t _ServiceMsg_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plumbing_interface_demo, srv, ServiceMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plumbing_interface_demo, srv, ServiceMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plumbing_interface_demo, srv, ServiceMsg)() {
  return &::plumbing_interface_demo::srv::rosidl_typesupport_c::ServiceMsg_service_type_support_handle;
}
