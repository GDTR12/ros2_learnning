...
static const _ServiceExercise_Request_type_support_symbol_names_t _ServiceExercise_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plumbing_interface_demo, srv, ServiceExercise_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plumbing_interface_demo, srv, ServiceExercise_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plumbing_interface_demo, srv, ServiceExercise_Request)() {
  return &::plumbing_interface_demo::srv::rosidl_typesupport_c::ServiceExercise_Request_message_type_support_handle;
}
...
static const _ServiceExercise_Response_type_support_symbol_names_t _ServiceExercise_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plumbing_interface_demo, srv, ServiceExercise_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plumbing_interface_demo, srv, ServiceExercise_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plumbing_interface_demo, srv, ServiceExercise_Response)() {
  return &::plumbing_interface_demo::srv::rosidl_typesupport_c::ServiceExercise_Response_message_type_support_handle;
}
...
static const _ServiceExercise_type_support_symbol_names_t _ServiceExercise_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plumbing_interface_demo, srv, ServiceExercise)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plumbing_interface_demo, srv, ServiceExercise)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plumbing_interface_demo, srv, ServiceExercise)() {
  return &::plumbing_interface_demo::srv::rosidl_typesupport_c::ServiceExercise_service_type_support_handle;
}
